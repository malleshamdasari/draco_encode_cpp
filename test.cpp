...
// int draco_to_open3d(open3d::geometry::TriangleMesh *outOpen3d, draco::EncoderBuffer *meshBuffer){
int draco_to_open3d(open3d::geometry::TriangleMesh * outOpen3d, draco::EncoderBuffer *meshBuffer){
    draco::DecoderBuffer decoderBuffer;
    decoderBuffer.Init(meshBuffer->data(), meshBuffer->size());
    ...
    // outOpen3d->triangles_.clear();
    // outOpen3d->triangle_normals_.clear();
...
int main(int argc, char const *argv[])
{
    ...
    // open3d::geometry::TriangleMesh *outOpen3d;
    auto outOpen3d = std::make_shared<open3d::geometry::TriangleMesh>();
    draco_to_open3d(outOpen3d.get(), &meshBuffer);
    ...
    delta("elapsed time: ");
    // auto open3dOutMesh = std::make_shared<open3d::geometry::TriangleMesh>();
    // open3dOutMesh.reset(outOpen3d);
    // open3d::visualization::DrawGeometries({open3dOutMesh}, "Mesh", 1600, 900);
    open3d::visualization::DrawGeometries({outOpen3d}, "Mesh", 1600, 900);
    // open3d::visualization::DrawGeometries({&outOpen3d}, "Mesh", 1600, 900);
    return 0;
}