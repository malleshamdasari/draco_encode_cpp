...
class StdioFileWriter : public draco::FileWriterInterface {
 public:
  ...
  static std::unique_ptr<FileWriterInterface> Open(const std::string &file_name);
  static std::unique_ptr<FileWriterInterface> OpenBuffer(FILE *pFileBuffer);
